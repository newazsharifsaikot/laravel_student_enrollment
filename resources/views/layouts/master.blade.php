...
<div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="{{URL::to('dashboard')}}"><h5>Student"s Enrollment</h5></a>
        </div>
        ...
        <div class="row row-offcanvas row-offcanvas-right">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#teacher_layouts" aria-expanded="false" aria-controls="sidebar_layouts">
                            <i class="mdi mdi-format-list-bulleted menu-icon"></i>
                            <span class="menu-title">Teacher</span>
                            <i class="mdi mdi-chevron-down menu-arrow"></i>
                        </a>
                        <div class="collapse" id="teacher_layouts">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{URL::TO('teacher')}}">All Teacher</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{URL::to('teacher/create')}}">Add Teacher</a>
                                </li>
                            </ul>
                        </div>
                    </li>
