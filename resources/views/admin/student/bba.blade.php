...
@section('content')
    <div class="content-wrapper">
        <h1 class="page-title">BBA Student Info</h1>
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <table id="order-listing" class="table table-striped" style="width:100%;">
                            ...
                            <tbody>
                            @foreach($bba_students as $key=>$student)
                            <tr>
                                <td>{{$key + 1}}</td>
                               ...
                               <td>
                                   ...
                                   <button type="button" class="btn btn-danger" onclick="deleteBbaStudent({{$student->id}})">
                                       <i class="material-icons">delete</i>
                                   </button>
                                   <form id="delete-form-{{$student->id}}" action="{{route('bba.destroy', $student->id)}}" method="post" style="display: none">
                                       @csrf
                                       @method('DELETE')
                                   </form>
                               </td>
